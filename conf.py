...
exclude_patterns = ['_build','/wassup/_build','/wassup/built-docs']
...
#html_theme_path = []
#html_theme_path = ['../../../cherries/themes']
...
# ]
#
# generates a .tex not a .pdf, "project" var defined above.

latex_documents = [
('pcbsd', 'pcbsd.tex', project,
   u'iXsystems', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "images/watermark.png"
...
# Guessing that the latex generation ought have similar configs
#latex_last_updated_fmt = '%b %d, %Y'
latex_last_updated_fmt = ''
...
locale_dirs = ['/wassup/built-docs/locale-po/']
